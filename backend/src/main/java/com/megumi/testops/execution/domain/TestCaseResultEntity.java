...
public class TestCaseResultEntity {
    ...
    public TestCaseResultEntity(ExecutionEntity execution, TestCaseEntity testCase) { this.id = UUID.randomUUID(); this.execution = execution; this.testCase = testCase; this.status = ExecutionStatus.QUEUED; this.caseNameSnapshot = testCase.getName(); }
