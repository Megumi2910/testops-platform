...
public final class ExecutionDtos {
    ...
    public record ExecutionQueuedResponse(UUID executionId, String status, boolean canCancel) { }
    public record ExecutionSummaryResponse(UUID id, UUID projectId, UUID suiteId, String status, boolean canCancel,
            int totalCases, int completedCases,
    ...
    public record ExecutionResponse(UUID id, UUID projectId, UUID suiteId, String status, boolean canCancel,
            int totalCases, int completedCases,
    ...
    public record CaseResultResponse(UUID id, UUID caseId, String caseName, String status, int attemptCount, Instant startedAt,
            Instant finishedAt, String errorMessage, Integer failedStepPosition, String errorCategory,
            boolean evidenceSuppressed, String evidenceSuppressionReason, List<StepResultResponse> steps) { }
