...
public class DefinitionService {
    private static final Set<String> ACTIONS = Set.of("NAVIGATE", "CLICK", "FILL", "CLEAR", "SELECT_OPTION", "CHECK", "UNCHECK", "WAIT", "WAIT_VISIBLE", "WAIT_HIDDEN", "ASSERT_TEXT_EQUALS", "ASSERT_TEXT_CONTAINS", "ASSERT_VISIBLE", "ASSERT_HIDDEN", "ASSERT_URL_CONTAINS", "TAKE_SCREENSHOT");
    private static final Set<String> LOCATOR_ACTIONS = Set.of("CLICK", "FILL", "CLEAR", "SELECT_OPTION", "CHECK", "UNCHECK", "WAIT_VISIBLE", "WAIT_HIDDEN", "ASSERT_TEXT_EQUALS", "ASSERT_TEXT_CONTAINS", "ASSERT_VISIBLE", "ASSERT_HIDDEN");
    private static final Set<String> LOCATOR_TYPES = Set.of("ROLE", "LABEL", "TEST_ID", "TEXT", "PLACEHOLDER", "ALT_TEXT", "TITLE", "CSS", "XPATH");
