...
- Reviewing authorization and resource lifecycle closure: [Phase 7 implementation](implementation/91-phase7-authorization-resource-lifecycle.md) → [acceptance evidence](testing/100-phase7-authorization-resource-lifecycle.md).
- Reviewing the Phase 6 account shell and security matrices: [shell implementation](implementation/100-phase6-account-shell-matrix.md) → [shell evidence boundary](testing/100-phase6-account-shell-matrix.md) → [security implementation](implementation/101-phase6-account-security-matrix.md) → [security evidence boundary](testing/101-phase6-account-security-matrix.md).
