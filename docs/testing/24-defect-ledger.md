...
| QG-B07 | remaining membership HTTP/browser matrix | focused service/MockMvc/PostgreSQL covers ancestry, cancellation, versions, archive, and final manager; PM UI now supports role update/removal with conflict guidance; complete live PM/viewer acceptance and positive add/remove/duplicate HTTP journeys |
