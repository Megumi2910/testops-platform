...
| QG-B07 | remaining membership HTTP/browser matrix | service/MockMvc/PostgreSQL covers ancestry, cancellation, versions, archive, and final manager; PM and direct-URL viewer DevTools acceptance is complete; add positive add/remove/duplicate plus test-manager/tester/non-member/admin journeys |
