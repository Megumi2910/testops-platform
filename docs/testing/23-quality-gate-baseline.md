...
| --- | --- | --- | --- |
| TestOps | `0657c2c0d5363a110c8b2775f69de1d4e8a883aa` | Isolated `testops-quality-gate` backend/frontend OCI `org.opencontainers.image.revision` labels match; PostgreSQL, Mailpit, pgAdmin, backend, and frontend report healthy; health/UI probes return 200 | PASS |
