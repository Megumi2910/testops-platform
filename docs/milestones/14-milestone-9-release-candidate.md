...
- catalog dry-run: 9 suites and 34 cases with no API calls;
- authenticated catalog apply: 9 suites and 34 cases reconciled with
  redacted variables;
- live target check: `REACHABLE`/HTTP 200;
- all 29 current READY catalog cases: passed, 220 steps; twenty-seven screenshot-bearing
...
and resilience/accessibility suites passed 1/1, 10/10, 9/9, 2/2, 4/4, and 3/3
